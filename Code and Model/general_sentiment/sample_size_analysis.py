...
neg_df = FrameParams(
    df=df[df['general_sentiment'] == -1], 
    class_name='negative', 
    class_val=0
)
neu_df = FrameParams(
    df=df[df['general_sentiment'] == 0], 
    class_name='neutral', 
    class_val=1
)
pos_df = FrameParams(
...
log_path = "/opt/localdata/Data/bea/nlp/bmi550/project/Chronic_Pain_Sentiment_NLP/models/general_sentiment/logs/roberta_opt_2.json"
# open the log file
