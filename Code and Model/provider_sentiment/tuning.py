...
class HyperParamOptimizer:
    ...
    def load_data(self, file_path: str, label_col: str):
        self.loader_dict = load_data_to_loader_dict(file_path, label_col)
        print("Data loaded...")
    ...
    def objective_function(self, dropout_proportion, learning_rate):
        ...
        """
        # set seed
        seed_script(self.seed)
        
        # build the model and send it to the gpu
        model = CustomRoberta(dropout_proportion, 3)
